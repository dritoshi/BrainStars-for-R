...
\author{Itoshi Nikaido$^\ddagger$\footnote{dritoshi@gmail.com} \and Takeya Kasukawa$^\ddagger$}
\usepackage{Sweave}
\begin{document}
...
We can retrive some kind of barplots and brain map images from BrainStars.
...
\begin{Schunk}
\begin{Sinput}
> mk.genes <- getBrainStarsMarker("high/LS/count")
\end{Sinput}
\end{Schunk}
...
The view provides lists of genes in gene families or in a gene categories. 
\begin{Schunk}
\begin{Sinput}
